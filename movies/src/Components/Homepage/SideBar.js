        ...
        <Nav style={{ padding: "50px 40px", backgroundColor: "#D3D3D3", }}>
            ...
            <Nav.Item>
                ...
                <h5 style={{ textDecoration: "none" }}>
                    ...
                    <Nav.Link as={Link} to="/movies" onClick={() => props.selectList}>Titles</Nav.Link>
                    <Nav.Link as={Link} to="/collections" onClick={() => props.selectList}>Collections</Nav.Link>
                    <Nav.Link as={Link} to="/reviews" onClick={() => props.selectList}>Reviews</Nav.Link>
                </h5>
